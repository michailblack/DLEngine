...
void WorldLayer::OnAttach()
{
    ...
    pointLight.Luminance = DLEngine::Math::Vec3{ 10.0f, 20.0f, 120.0f };
    ...
    pointLight.Position = DLEngine::Math::Vec3{ 0.0f };
    pointLight.Linear = 0.7f;
    pointLight.Luminance = DLEngine::Math::Vec3{ 20.0f, 120.0f, 10.0f };
    pointLight.Quadratic = 1.8f;
    ...
    spotLight.Luminance = DLEngine::Math::Vec3{ 40.0f, 10.0f, 150.0f };
